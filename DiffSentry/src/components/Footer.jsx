        ...
        <div className="container-custom">
            ...
            >
              <div className="flex items-center mb-4 justify-center">
                <a href="#" className="flex items-center">
                  ...
                  <span className="text-lg font-bold ml-2">DiffSentry</span>
                </a>
              </div>
              <p className="text-gray-400 text-center leading-loose mt-6 mb-4">
          ...
          >
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/KyleVitayanuvatti" className="text-gray-400 hover:text-primary transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24" className="h-5 w-5">
              ...
              <a href="https://www.linkedin.com/in/kyle-vitayanuvatti/" className="text-gray-400 hover:text-primary transition-colors">
                <svg fill="currentColor" viewBox="0 0 24 24" className="h-5 w-5">
