  ...
  return (
    <section className="pb-16 relative flex flex-col items-center justify-center w-full min-h-screen mx-auto bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      <div className="relative w-full aspect-[1920/1200] overflow-hidden">
        ...
        {/* Dark Overlay */}
        <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-gray-100 via-gray-200/80 to-gray-50 dark:from-gray-900 dark:via-gray-800/80 dark:to-gray-900 z-10"></div>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-20 w-full max-w-4xl px-4">
          ...
          >
            <p className="text-xl mt-6 text-gray-700 dark:text-gray-200 leading-relaxed">
      ...
      <div className="max-w-4xl w-full mt-16 px-4">
        ...
        <Motion.div 
          ...
          className="mb-12 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700"
        >
          <h2 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Making a Change</h2>
        ...
        <Motion.div 
          ...
          className="mb-12 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700"
        >
          <h2 className="text-2xl font-bold text-rose-600 dark:text-rose-400">Protecting Open Source</h2>
        ...
        <Motion.div 
          ...
          className="mb-12"
        >
          <h2 className="text-2xl font-bold text-cyan-600 dark:text-cyan-400 mb-2">The Team</h2>
          ...
          <p className="italic text-sm text-gray-500 dark:text-gray-400 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8 max-w-3xl mx-auto">
            {teamMembers.map((member, index) => (
              <Motion.a 
                ...
                className="block"
              >
                <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 transition-all hover:border-cyan-500/50">
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex items-center mt-2">
                      <svg className="w-4 h-4 text-cyan-600 dark:text-cyan-400 mr-1" fill="currentColor" viewBox="0 0 24 24">
